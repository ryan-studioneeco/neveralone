...
namespace Foliage
{
    ...
    public class Foliage2D_Animation : MonoBehaviour
    {
        ...
        /// <summary>
        /// The initial animation speed (before animation speed is set and used to offset animations)
        /// </summary>
        public float initialOffsetAnimationSpeed = 0.5f;
        /// <summary>
        /// The  value for a animation speed.
        /// </summary>
        public float animationSpeed = 0.5f;
        /// <summary>
        /// The wait time before set animation speed kicks in
        /// </summary>
        public float offsetTime = 1;
        public float multiplySpeedPercent = 1f;
        public float randomizeSpeedPercent = 0.2f;
        public float randomizeOffsetPercent = 0.2f;

        [Button("Multiply Initial Speed")]
        void MultiplyInitialSpeed() {
            this.initialOffsetAnimationSpeed *=  this.multiplySpeedPercent;
        }
        [Button("Randomize Initial Speed")]
        void RandomizeSpeed() {
            this.initialOffsetAnimationSpeed *=  1 + Random.Range(-this.randomizeSpeedPercent, this.randomizeSpeedPercent);
        }
        [Button("Randomize Offset")]
        void RandomizeOffset() {
            this.offsetTime *= 1 + Random.Range(-this.randomizeOffsetPercent, this.randomizeOffsetPercent);
        }
        ...
        {
            animator.speed = this.initialOffsetAnimationSpeed;
        ...
        private void SimpleMeshBending()
        {
            ...
            {
                posOffset[i] = this.offsetMultiplier * new Vector3(offset.x * offsetFactor[i], offset.y * offsetFactor[i], offset.z * offsetFactor[i]);
        ...
        { 
            ...
            {
                float xOffset = this.offsetMultiplier * offset.x * offsetFactor[i];
